    ...
    <>
      ...
      >
        <TouchableOpacity
          ...
          accessibilityLabel={
            isExpanded ? "Close AI Assistant" : "Open AI Assistant"
          }
          ...
          <FrostedGlass style={styles.actionsContainer}>
            ...
            <View style={styles.quickActions}>
              <TouchableOpacity
                ...
                accessibilityRole="button"
                accessibilityLabel="Get Diagnosis Help"
              >
                <View
                  style={[
              ...
              <TouchableOpacity
                ...
                accessibilityRole="button"
                accessibilityLabel="View Protocol Guide"
              >
                <View
                  style={[
                    styles.quickActionIcon,
              ...
              <TouchableOpacity
                ...
                accessibilityRole="button"
                accessibilityLabel="Access Emergency Support"
              >
                <View
                  style={[
                    styles.quickActionIcon,
