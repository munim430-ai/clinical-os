...
function calcIcon(id: string, color: string, size = 18) {
  switch (id) {
    case "bmi":
      return <Scale size={size} color={color} strokeWidth={1.8} />;
    case "egfr":
      return <Droplets size={size} color={color} strokeWidth={1.8} />;
    case "peds":
      return <Baby size={size} color={color} strokeWidth={1.8} />;
    case "preg":
      ...
      {result && (
        <View
          style={{
            ...
            padding: 16,
            alignItems: "center",
            backgroundColor: result.catColor + "18",
            borderWidth: 1,
            borderColor: result.catColor + "30",
          }}
        >
          <Text
            style={{
...
export function DailyPulse() {
  ...
  return (
    <>
        ...
        <View style={{ flex: 1, padding: 14, paddingBottom: 10 }}>
                ...
                {CALCS.map((calc) => (
                  ...
                  >
                    <TouchableOpacity
                      ...
                      accessibilityLabel={`${calc.label} calculator`}
                      style={{
                        width: 44,
                        height: 44,
                        borderRadius: 14,
          ...
          <View style={{ alignItems: "flex-end", marginTop: 8 }}>
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              accessibilityRole="button"
              accessibilityLabel={`View featured drug: ${sponsor.brand}`}
              style={{
                flexDirection: "row",
                alignItems: "center",
                gap: 5,
      ...
      {/* ── Pearl detail sheet ──────────────────────── */}
      <SheetModal
        visible={showPearlDetail}
        onClose={() => setShowPearlDetail(false)}
      ...
      >
        <View style={{ padding: 20, gap: 16 }}>
          ...
          <TouchableOpacity
            onPress={() => {
              triggerSelectionHaptic();
              setPearlIdx((i) => (i + 1) % PEARLS.length);
            }}
            activeOpacity={0.7}
            style={{
              borderRadius: 14,
        ...
        <View style={{ padding: 20, gap: 16 }}>
          <View
            style={{
              ...
              padding: 16,
              borderRadius: 16,
              backgroundColor: sponsor.color + "10",
            }}
          >
            <View
              style={{
          ...
          {[
            {
              icon: <Stethoscope size={16} color={TEAL} strokeWidth={1.8} />,
              label: "Indication",
              val: sponsor.indication,
            },
            {
              icon: <Clock size={16} color={TEAL} strokeWidth={1.8} />,
              label: "Dosing",
              val: sponsor.dosing,
            },
          ].map((row) => (
          ...
          >
            Sponsored content · Always verify with current prescribing
            information.
          </Text>
        </View>
      </SheetModal>
      ...
      <SheetModal
        ...
        title={activeCalc ? `${activeCalc.label} Calculator` : ""}
      >
        {activeCalc?.id === "bmi" ? (
