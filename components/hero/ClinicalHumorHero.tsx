...
export function ClinicalHumorHero({
  ...
  return (
    <View
      className={compact ? "items-center py-5" : "items-center px-6 pb-8 pt-4"}
    >
      <View className={compact ? "h-[210px] w-full" : "h-[294px] w-full"}>
        ...
        >
          <View className="h-16 w-16 rounded-[24px] border border-border bg-surface" />
          <View className="mt-[-4px] h-20 w-24 rounded-[28px] border border-border bg-text-primary px-3 py-4">
            ...
            <View className="mt-3 h-2 w-14 rounded-pill bg-surface-muted" />
            <View className="mt-2 h-2 w-10 rounded-pill bg-surface-muted" />
          </View>
          <View className="mt-[-6px] h-8 w-16 rounded-b-[20px] bg-surface-muted" />
        </MotiView>
        ...
        <FloatingIcon className="left-8 top-10" delay={0}>
          <Activity size={22} color="#2BC97A" strokeWidth={1.5} />
        </FloatingIcon>

        <FloatingIcon className="right-8 top-16" delay={200}>
          <ClipboardCheck size={22} color="#2470FF" strokeWidth={1.5} />
        </FloatingIcon>

        <FloatingIcon className="bottom-10 left-10" delay={400}>
          <Pill size={22} color="#2470FF" strokeWidth={1.5} />
        </FloatingIcon>

        <FloatingIcon className="bottom-8 right-10" delay={600}>
          <Stethoscope size={22} color="#2BC97A" strokeWidth={1.5} />
        </FloatingIcon>
        ...
        >
          <Siren size={15} color="#FF3B30" strokeWidth={1.7} />
      ...
      <Text
        className={
          compact
            ? "mt-1 text-center font-heading text-[24px] leading-8 text-text-primary"
            : "mt-2 text-center font-heading text-[32px] leading-[38px] text-text-primary"
        }
      >
        {title}
      </Text>
      <Text
        className={
          compact
            ? "mt-2 max-w-[280px] text-center font-body text-[13px] leading-5 text-text-secondary"
            : "mt-3 max-w-[320px] text-center font-body text-[15px] leading-6 text-text-secondary"
        }
      >
        {subtitle}
      </Text>
...
function FloatingIcon({
  ...
  return (
    <MotiView
      ...
      className={`absolute h-12 w-12 items-center justify-center rounded-2xl border border-border bg-surface ${className}`}
    >
      {children}
    </MotiView>
  );
