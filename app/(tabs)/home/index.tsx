          ...
          <View className="rounded-t-[28px] bg-surface-elevated p-6 pb-10">
            <View className="mb-5 flex-row items-center justify-between">
              ...
              <TouchableOpacity
                ...
                accessibilityLabel="Close BMI Calculator"
          ...
          <View className="rounded-t-[28px] bg-surface-elevated p-6 pb-10">
            <View className="mb-5 flex-row items-center justify-between">
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                accessibilityRole="button"
                accessibilityLabel="Close eGFR Calculator"
                hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}
              >
                <X size={20} color="#7A7A80" />
              </TouchableOpacity>
          ...
          <View className="rounded-t-[28px] bg-surface-elevated p-6 pb-10">
            <View className="mb-4 flex-row items-center justify-between">
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                accessibilityRole="button"
                accessibilityLabel="Close Paediatric Dose Calculator"
                hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}
              >
                <X size={20} color="#7A7A80" />
              </TouchableOpacity>
          ...
          <View className="rounded-t-[28px] bg-surface-elevated p-6 pb-10">
            <View className="mb-5 flex-row items-center justify-between">
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
                accessibilityRole="button"
                accessibilityLabel="Close Pregnancy Wheel"
                hitSlop={{ top: 10, bottom: 10, left: 10, right: 10 }}
              >
                <X size={20} color="#7A7A80" />
              </TouchableOpacity>
